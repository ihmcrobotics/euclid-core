 ...
 * where a matrix needs to be inverted.
 * Typically, this corresponds to when a matrix is singular, i.e.
 * its determinant is equal to zero, making impossible to compute
 * its inverse.
 * 
 * @author Sylvain
 *
...
public class SingularMatrixException extends RuntimeException
{
   ...
   /**
    * Constructs an {@code SingularMatrixException} with no
    * detail message.
    */
   ...
   /**
    * Constructs an {@code SingularMatrixException} with the
   ...
   /**
    * Constructs an {@code SingularMatrixException} with a
