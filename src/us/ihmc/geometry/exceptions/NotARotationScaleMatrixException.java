 ...
 * expecting a rotation-scale matrix.
 * 
 * @author Sylvain
 *
 */
public class NotARotationScaleMatrixException extends RuntimeException
{
   ...
   /**
    * Constructs an {@code NotARotationScaleMatrixException} with no
    * detail message.
    */
   ...
   /**
    * Constructs an {@code NotARotationScaleMatrixException} with the
   ...
   /**
    * Constructs an {@code NotARotationScaleMatrixException} with a
