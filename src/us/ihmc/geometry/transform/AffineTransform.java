...
/**
 * An {@code AffineTransform} represents a 4-by-4 transformation matrix that can scale, rotate, and translate.
 * <p>
...
public class AffineTransform implements Transform, EpsilonComparable<AffineTransform>, Settable<AffineTransform>
{
    ...
    * @throws NotARotationScaleMatrixException if the resulting matrix for the rotation-scale
    *  part of this transform is not a rotation-scale matrix.
    */
   ...
   /**
    * Packs the rotation and translation parts of this transform in the given
    * rigid-body transform.
    * 
    * @param rigidBodyTransformToPack the transform in which the rotation and translation parts
    *  of this affine transform are stored. Modified.
    */
    ...
    */
   public void get(Matrix3DBasics<?> rotationScaleMarixToPack, Tuple3DBasics<Vector3D> translationToPack)
   {
    ...
    * @param translationToPack tuple in which the translation vector of this affine transform is stored. Modified.
    */
   public void get(RotationScaleMatrix rotationScaleMarixToPack, Tuple3DBasics<Vector3D> translationToPack)
   {
      rotationScaleMarixToPack.set(rotationScaleMatrix);
      translationToPack.set(translationVector);
   }
   ...
   /**
    * Tests separately and on a per component basis if the rotation part, the scale part, and the translation
    ...
    * in which case the method returns {@link #equals(AffineTransform)}, 
