...
public interface Transform
{
    ...
    * <p>
    * This is equivalent to calling {@link #transform(Point3DBasics)}
   ...
   /**
    * Performs the inverse of the transform on the given point {@code pointOriginal}
    * and stores the result in {@code pointTransformed}.
    * <p>
    * This is equivalent to calling {@link #transform(Point3DReadOnly, Point3DBasics)}
    * with the inverse of this transform.
    * </p>
    * 
    * @param pointOriginal the point to transform. Not modified.
    ...
    * <p>
    * This is equivalent to calling {@link #transform(Vector3DBasics)}
    * with the inverse of this transform.
    * </p>
    * 
    * @param vectorToTransform the vector to transform. Modified.
   ...
   /**
    * Performs the inverse of the transform on the given vector {@code vectorOriginal}
    * and stores the result in {@code vectorTransformed}.
    * <p>
    * This is equivalent to calling {@link #transform(Vector3DReadOnly, Vector3DBasics)}
    * with the inverse of this transform.
    * </p>
    * 
    * @param vectorOriginal the vector to transform. Not modified.
    ...
    * <p>
    * This is equivalent to calling {@link #transform(QuaternionBasics)}
    * with the inverse of this transform.
    * </p>
    * 
    * @param quaternionToTransform the quaternion to transform. Modified.
   ...
   /**
    * Performs the inverse of the transform on the given quaternion {@code quaternionOriginal}
    * and stores the result in {@code quaternionTransformed}.
    * <p>
    * This is equivalent to calling {@link #transform(QuaternionReadOnly, QuaternionBasics)}
    * with the inverse of this transform.
    * </p>
    * 
    * @param quaternionOriginal the quaternion to transform. Not modified.
    ...
    * Performs the inverse of the transform on the given vector {@code vectorToTransform}.
    * <p>
    * This is equivalent to calling {@link #transform(Vector4DBasics)}
    * with the inverse of this transform.
    * </p>
    * 
    * @param vectorToTransform the 4D vector to transform. Modified.
    ...
    * and stores the result in {@code vectorTransformed}.
    * <p>
    * This is equivalent to calling {@link #transform(Vector4DReadOnly, Vector4DBasics)}
    * with the inverse of this transform.
    * </p>
    * 
    * @param vectorOriginal the 4D vector to transform. Not modified.
    ...
    * Performs the inverse of the transform on the given point {@code pointToTransform}.
    * <p>
    * This is equivalent to calling {@link #transform(Point2DBasics)}
    * with the inverse of this transform.
    * </p>
    * 
    ...
    * and stores the result in {@code pointTransformed}.
    * <p>
    * This is equivalent to calling {@link #transform(Point2DReadOnly, Point2DBasics)}
    * with the inverse of this transform.
    * </p>
    * 
    ...
    * Performs the inverse of the transform on the given point {@code pointToTransform}.
    * <p>
    * This is equivalent to calling {@link #transform(Point2DBasics, boolean)}
    * with the inverse of this transform.
    * </p>
    * 
    * @param point2DToTransform the point to transform. Modified.
    ...
    * and stores the result in {@code pointTransformed}.
    * <p>
    * This is equivalent to calling {@link #transform(Point2DReadOnly, Point2DBasics, boolean)}
    * with the inverse of this transform.
    * </p>
    * 
    * @param point2DOriginal the point to transform. Not modified.
    ...
    * Performs the inverse of the transform on the given vector {@code vectorToTransform}.
    * <p>
    * This is equivalent to calling {@link #transform(Vector2DBasics)}
    * with the inverse of this transform.
    * </p>
    * 
    ...
    * and stores the result in {@code vectorTransformed}.
    * <p>
    * This is equivalent to calling {@link #transform(Vector2DReadOnly, Vector2DBasics)}
    * with the inverse of this transform.
    * </p>
    * 
    ...
    * Performs the inverse of the transform on the given vector {@code vectorToTransform}.
    * <p>
    * This is equivalent to calling {@link #transform(Vector2DBasics, boolean)}
    * with the inverse of this transform.
    * </p>
    * 
    * @param vector2DToTransform the vector to transform. Modified.
    ...
    * <p>
    * This is equivalent to calling {@link #transform(Matrix3D)}
    * with the inverse of this transform.
    * </p>
    * 
    * @param matrixToTransform the matrix to transform. Modified.
   ...
   /**
    * Performs the inverse of the transform on the given matrix {@code matrixOriginal}
    * and stores the result in {@code matrixTransformed}.
    * <p>
    * This is equivalent to calling {@link #transform(Matrix3DReadOnly, Matrix3D)}
    * with the inverse of this transform.
    * </p>
    * 
    * @param matrixOriginal the matrix to transform. Not modified.
    ...
    * <p>
    * This is equivalent to calling {@link #transform(RotationMatrix)}
    * with the inverse of this transform.
    * </p>
    * 
    * @param matrixToTransform the rotation matrix to transform. Modified.
    ...
    * and stores the result in {@code matrixTransformed}.
    * <p>
    * This is equivalent to calling {@link #transform(RotationMatrixReadOnly, RotationMatrix)}
    * with the inverse of this transform.
    * </p>
    * 
    * @param matrixOriginal the rotation matrix to transform. Not modified.
